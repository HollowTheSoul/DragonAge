...
\begin{itemize}
    ...
    \item The users should earn resources after killing each enemy. The resource amount earned \st{is based on the wave} \textcolor{red}{starts at} 
    ...
    \st{\item The game shall enable the start and pause button for the ease of users to set up dragons in between waves.}
...
\subsubsection{\sout{Audit Requirements}}
\st{Not applicable.}
\subsubsection{\sout{Immunity Requirements}}
\st{Not applicable.}
